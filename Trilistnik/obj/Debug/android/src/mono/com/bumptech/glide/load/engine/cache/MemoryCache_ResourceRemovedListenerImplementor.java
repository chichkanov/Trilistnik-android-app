...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Bumptech.Glide.Load.Engine.Cache.IMemoryCacheResourceRemovedListenerImplementor, Glide, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MemoryCache_ResourceRemovedListenerImplementor.class, __md_methods);
	}


	public MemoryCache_ResourceRemovedListenerImplementor () throws java.lang.Throwable
	{
		super ();
		if (getClass () == MemoryCache_ResourceRemovedListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Bumptech.Glide.Load.Engine.Cache.IMemoryCacheResourceRemovedListenerImplementor, Glide, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
