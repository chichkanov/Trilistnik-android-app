...
{
	public class MeetupsFragment : Android.Support.V4.App.Fragment
	{
		private static String ARG_TITLE = "Мероприятия";
		...
		public static MeetupsFragment NewInstance(String param1)
		{
		...
		public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		{
			...
			fab.Click += (sender, e) =>
			{
				AddMeetupDialogFragment dialogFragment = new AddMeetupDialogFragment();
				dialogFragment.onItemAdded += (GoodsItem obj) =>
				{
					dataset.Add(obj);
					adapter.NotifyDataSetChanged();
				};
				dialogFragment.Show(Activity.FragmentManager, AddMeetupDialogFragment.TAG);
			};
